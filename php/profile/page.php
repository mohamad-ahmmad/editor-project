              ...
              <div class="row">
                ...
                <div class="col-8">
                  <div class="card-body position-relative">
                    <input type="text" name="project-id" value="3" hidden>
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a data-bs-toggle="modal" data-edit-project="3" data-bs-target="#staticBackdrop" class="dropdown-item" href="#">Edit</a>
                      </li>
                      <li>
                        <a data-bs-toggle="modal" data-id-project="3" data-bs-target="#exampleModal" class="dropdown-item">Delete</a>
                      </li>
                    </ul>
