...
function cs(s) {
  const t = ls(s);
  return (s.uidEvent = t), (Qt[t] = Qt[t] || {}), Qt[t];
}
function nn(s, t) {
  return function e(n) {
    return (
...
class At {
  ...
  _mergeConfigObj(t, e) {
    const n = x(e) ? z.getDataAttribute(e, "config") : {};
    return {
      ...this.constructor.Default,
      ...(typeof n == "object" ? n : {}),
      ...(x(e) ? z.getDataAttributes(e) : {}),
      ...(typeof t == "object" ? t : {}),
    };
  }
...
class L extends At {
  ...
  static getInstance(t) {
    return Xt.get(W(t), this.DATA_KEY);
  }
...
class bt extends L {
  constructor(t, e) {
    super(t, e),
      ...
      (this._indicatorsElement = _.findOne(Xn, this._element)),
  ...
  _addEventListeners() {
    this._config.keyboard && r.on(this._element, xn, (t) => this._keydown(t)),
      this._config.pause === "hover" &&
        (r.on(this._element, zn, () => this.pause()),
        r.on(this._element, Hn, () => this._maybeEnableCycle())),
      this._config.touch && Vt.isSupported() && this._addTouchEventListeners();
  }
  _addTouchEventListeners() {
    for (const n of _.find(Qn, this._element))
...
const De = "dropdown",
  ...
  zi = S() ? "bottom-end" : "bottom-start",
  Hi = S() ? "bottom-start" : "bottom-end",
...
class M extends L {
  ...
  _getPlacement() {
    ...
    const e =
      ...
      "end";
    return t.classList.contains(wi) ? (e ? xi : Vi) : e ? Hi : zi;
  }
  _detectNavbar() {
...
class he {
  ...
  _resetElementAttributes(t, e) {
    const n = (i) => {
      const l = z.getDataAttribute(i, e);
      if (l === null) {
        i.style.removeProperty(e);
        return;
      }
      z.removeDataAttribute(i, e), i.style.setProperty(e, l);
    };
...
class rt extends L {
  ...
  _showElement(t) {
    ...
    e && (e.scrollTop = 0), Et(this._element), this._element.classList.add(ze);
    const n = () => {
...
class Y extends L {
  ...
  hide() {
    ...
    this._focustrap.deactivate(),
      ...
      this._backdrop.hide();
    const e = () => {
      this._element.classList.remove(He, We),
        this._element.removeAttribute("aria-modal"),
        this._element.removeAttribute("role"),
...
const Vr = new Set([
  ...
  Kr = (s, t) => {
    ...
    return t.includes(e)
      ? Vr.has(e)
        ? Boolean(zr.test(s.nodeValue) || Hr.test(s.nodeValue))
        : !0
...
class ct extends L {
  ...
  _createTipElement(t) {
    ...
    const n = Qs(this.constructor.NAME).toString();
    return (
...
const Ro = "tab",
  ...
  Qo = `.nav-link${oe}, .list-group-item${oe}, [role="tab"]${oe}`,
  Ds =
    '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
  ae = `${Qo}, ${Ds}`,
  Xo = `.${Q}[data-bs-toggle="tab"], .${Q}[data-bs-toggle="pill"], .${Q}[data-bs-toggle="list"]`;
class ot extends L {
  constructor(t) {
    super(t),
  ...
  _activate(t, e) {
    if (!t) return;
    t.classList.add(Q), this._activate(V(t));
    const n = () => {
      ...
      t.removeAttribute("tabindex"),
        ...
        r.trigger(t, zo, { relatedTarget: e });
    };
    this._queueCallback(n, t, t.classList.contains(Qe));
  }
  _deactivate(t, e) {
    if (!t) return;
    t.classList.remove(Q), t.blur(), this._deactivate(V(t));
    const n = () => {
      if (t.getAttribute("role") !== "tab") {
  ...
  _toggleDropDown(t, e) {
    ...
    i(Uo, Q), i(jo, re), n.setAttribute("aria-expanded", e);
  }
  _setAttributeIfNotExists(t, e, n) {
    t.hasAttribute(e) || t.setAttribute(e, n);
  }
  _elemIsActive(t) {
    return t.classList.contains(Q);
  }
  _getInnerElement(t) {
...
r.on(document, Ho, Ds, function (s) {
  ["A", "AREA"].includes(this.tagName) && s.preventDefault(),
    !F(this) && ot.getOrCreateInstance(this).show();
});
r.on(window, Wo, () => {
  for (const s of _.find(Xo)) ot.getOrCreateInstance(s);
});
C(ot);
const Zo = "toast",
  Jo = "bs.toast",
